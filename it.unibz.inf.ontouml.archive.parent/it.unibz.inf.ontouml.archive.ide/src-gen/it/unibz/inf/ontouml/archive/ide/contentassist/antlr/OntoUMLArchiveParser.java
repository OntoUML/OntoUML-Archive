		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getParthoodAssociationAccess().getGroup(), "rule__ParthoodAssociation__Group__0");
					...
					put(grammarAccess.getAssociationEndAccess().getGroup_4_2(), "rule__AssociationEnd__Group_4_2__0");
					...
					put(grammarAccess.getRegularAssociationAccess().getStereotypesAssignment_2(), "rule__RegularAssociation__StereotypesAssignment_2");
					...
					put(grammarAccess.getParthoodAssociationAccess().getNameAssignment_1(), "rule__ParthoodAssociation__NameAssignment_1");
					put(grammarAccess.getParthoodAssociationAccess().getStereotypesAssignment_2(), "rule__ParthoodAssociation__StereotypesAssignment_2");
					put(grammarAccess.getParthoodAssociationAccess().getWholeAssignment_4(), "rule__ParthoodAssociation__WholeAssignment_4");
					put(grammarAccess.getParthoodAssociationAccess().getPartAssignment_6(), "rule__ParthoodAssociation__PartAssignment_6");
					...
					put(grammarAccess.getAssociationEndAccess().getConstraintsAssignment_4_1(), "rule__AssociationEnd__ConstraintsAssignment_4_1");
					put(grammarAccess.getAssociationEndAccess().getConstraintsAssignment_4_2_1(), "rule__AssociationEnd__ConstraintsAssignment_4_2_1");
