 ...
 * </p>
 * <ul>
 *   <li>{@link it.unibz.inf.ontouml.archive.ontoUMLArchive.impl.GeneralizationSetImpl#isIsDisjoint <em>Is Disjoint</em>}</li>
 *   <li>{@link it.unibz.inf.ontouml.archive.ontoUMLArchive.impl.GeneralizationSetImpl#isIsComplete <em>Is Complete</em>}</li>
 *   <li>{@link it.unibz.inf.ontouml.archive.ontoUMLArchive.impl.GeneralizationSetImpl#getGeneralizations <em>Generalizations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GeneralizationSetImpl extends ModelElementImpl implements GeneralizationSet
{
  ...
  {
    return OntoUMLArchivePackage.Literals.GENERALIZATION_SET;
  }
  ...
  public void setIsDisjoint(boolean newIsDisjoint)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OntoUMLArchivePackage.GENERALIZATION_SET__IS_DISJOINT, oldIsDisjoint, isDisjoint));
  }
  ...
  public void setIsComplete(boolean newIsComplete)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OntoUMLArchivePackage.GENERALIZATION_SET__IS_COMPLETE, oldIsComplete, isComplete));
  }
  ...
  public EList<Generalization> getGeneralizations()
  {
    ...
    {
      generalizations = new EObjectContainmentEList<Generalization>(Generalization.class, this, OntoUMLArchivePackage.GENERALIZATION_SET__GENERALIZATIONS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case OntoUMLArchivePackage.GENERALIZATION_SET__GENERALIZATIONS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case OntoUMLArchivePackage.GENERALIZATION_SET__IS_DISJOINT:
        return isIsDisjoint();
      case OntoUMLArchivePackage.GENERALIZATION_SET__IS_COMPLETE:
        return isIsComplete();
      case OntoUMLArchivePackage.GENERALIZATION_SET__GENERALIZATIONS:
